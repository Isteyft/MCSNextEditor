export const STATUS_MESSAGES = {
    ...
    openProjectLoaded: (rootPath: string) => `项目已打开，并预加载全部目录数据: ${rootPath}`,
    openProjectLoadedFallback: (modRootPath: string) => `项目已打开，并按预设路径加载目录数据: ${modRootPath}`,
